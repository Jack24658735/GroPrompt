...
python3 inference_davis_online_sam_prop_dino_bbox.py --binary \
--output_dir=${OUTPUT_DIR} --dataset_file davis \
--online --use_SAM -s 480 --sam_ckpt_path ${SAM_CHECKPOINT} --visualize --iou_alpha 0.8 --prop_thres 0.35 --temp 0.1 ${PY_ARGS}
