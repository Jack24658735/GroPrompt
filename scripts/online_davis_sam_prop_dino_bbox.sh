...
python3 inference_davis_online_sam_prop_dino_bbox.py --with_box_refine --binary --freeze_text_encoder \
--output_dir=${OUTPUT_DIR} --dataset_file davis \
--online --use_SAM -s 480 --sam_ckpt_path ${SAM_CHECKPOINT} --visualize ${PY_ARGS}
