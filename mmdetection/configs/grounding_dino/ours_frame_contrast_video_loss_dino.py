...
#############################################################################################################
#############################################################################################################
# set sam_ckpt_path, loss_contrastive_weight, loss_contrastive_video_weight
#############################################################################################################
#############################################################################################################
...
model = dict(
    ...
    bbox_head=dict(
        type='GroundingDINOFrameContrastiveVideoHeadDINO',
        num_classes=65,
        ...
        loss_contrastive_video_weight=1.0,
)
