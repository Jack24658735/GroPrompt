...
class GroundingDINOFrameVideoLossDINO(DINO):
    ...
    def __init__(self, language_model, sam_ckpt_path=None, loss_contrastive_weight=1.0, loss_contrastive_video_weight=1.0, *args, **kwargs) -> None:
        ...
        self.loss_contrastive_video_weight = loss_contrastive_video_weight # for head use
    ...
    def pre_decoder_neg(
        ...
        """No query prop. for negative prompt"""
        bs, _, c = memory.shape
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        if NEG_VALID:
            ...
            contrastive_loss = self.bbox_head.loss_contrastive(bbox_pos, bbox_neg, bbox_gt, batch_data_samples)
            ...
            video_contrastive_loss = self.bbox_head.loss_video_contrastive(bbox_pos, batch_data_samples, text_dict, text_neg_dict, visual_features)
