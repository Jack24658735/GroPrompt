    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        if type(data) != dict: # our training pipeline
            ...
            for i in range(data_samples['boxes'][0].shape[0]):
                ...
                # flatten the list with [0]
                
                gt_instances.bboxes = data_samples['boxes'][0][i:i+1]
                # num_frames = 2
                #     [tensor([[ 2.6123e-04,  5.1022e-04,  8.5449e-05, -4.5718e-04],
                # [ 2.6947e-04,  5.1553e-04,  8.3618e-05, -4.2535e-04]], device='cuda:0')]
                
                # gt_instances.labels = data_samples['labels'][0]
